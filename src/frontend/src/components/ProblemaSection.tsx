...
function ProblemCard({ p }: { p: typeof problems[0] }) {
  ...
  return (
    <motion.article
      key={p.id}
      className="glass-card-ember rounded-none p-8 relative group transition-colors duration-300"
      whileHover={reduce ? {} : { y: -6, boxShadow: "0 0 30px rgba(249,115,22,0.15)" }}
